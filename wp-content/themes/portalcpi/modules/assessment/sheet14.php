        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    ...
                    //printAll($grinf);
                    if( $grinf->program_id == 14 && ($grinf->trener_id == get_current_user_id() || $grinf->independent_trainer_id == get_current_user_id() || $grinf->moderator_id == get_current_user_id() || $grinf->expert_id == get_current_user_id() )){
                ...
                GROUP BY a.create_user_id", $_GET['group'], $grinf->teamleader_id, $grinf->moderator_id, $grinf->independent_trainer_id ));
                    }
                    ?>
                    <?php if($data):?>
...
//                            if($grinf->program_id == 14 && $grinf->admin_id == get_current_user_id() ){
...
//                                }
//
//                            }elseif($grinf->program_id == 14 && $grinf->expert_id == get_current_user_id() ){
...
//                            }
                            ...
                            if($grinf->program_id == 14 && ( $grinf->independent_trainer_id == get_current_user_id() || $grinf->moderator_id == get_current_user_id() )){
                                $groupInfo = "";
                ...
                <b>'.$positiontext.':</b> '.$allName.'<br>';
                            ...
                            ${'tabdata_'.$r} = '<div role="tabpanel" class="tab-pane '.$active.'" id="tabdata_'.$r.'"><p>
                                ...
                                <table class="table table-bordered no-margin">
                                    ...
                                    <tr>
                                        <td>
                                            <b>'.ASSESSMENT_RUBRIC_14[0].'</b>
                                            '.ASSESSMENT_RUBRIC_14[6].'
                                        </td>
                                        <td>
                                            <b>'.ASSESSMENT_RUBRIC_14[2].'</b> '.ASSESSMENT_RUBRIC_14[6].'
                                        </td>
                                        <td>
                                            <b>'.ASSESSMENT_RUBRIC_14[4].'</b>
                                               '.ASSESSMENT_RUBRIC_14[6].'
                                        </td>
                                    </tr>'; ?>
