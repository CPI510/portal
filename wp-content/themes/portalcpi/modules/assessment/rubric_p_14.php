...
//    echo'<meta http-equiv="refresh" content="0;url=/groups/?z=group&id='.$_POST['id'].'" />';
    ...
    <div class="card">
        <?php if(isset($res) && !empty($res->id )): ?>
            ...
            <?php if( get_current_user_id() == $gropinfo->teamleader_id && ($res->grading_solution == 1 || $res->grading_solution == 2) ): ?>
                <a href="/export_to_word/?form=assessment_p_14&create_user_id=<?=$res->create_user_id?>&listener_id=<?=$res->listener_id?>&group=<?=$_GET['id']?>&ver=2" class="btn btn-primary"><?=  ASSESSMENT_SECOND[0] ?></a>
            <?php else:?>
                <a href="/export_to_word/?form=assessment_p_14&create_user_id=<?=$res->create_user_id?>&listener_id=<?=$res->listener_id?>&group=<?=$_GET['id']?>" class="btn btn-primary"><?= ($gropinfo->teamleader_id == get_current_user_id()) ? DOWNLOAD_JUSTIFICATION : ASSESSMENT_SECOND[0] ?></a>
            <?php endif; ?>
        <?php else: ?>
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered no-margin">
                <tr>
                    <td><b><?= ASSESSMENT_RUBRIC_14[0] ?></b></td>
                    <td>
                ...
                <tr>
                    <td><b><?= ASSESSMENT_RUBRIC_14[2] ?></b></td>
                    <td>
                        <?php if($gropinfo->teamleader_id1 == get_current_user_id()): ?>
                ...
                <tr>
                    <td><b><?= ASSESSMENT_RUBRIC_14[4] ?></b></td>
                    <td>
                        <?php if($gropinfo->teamleader_id1 == get_current_user_id()): ?>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group">
                <label for="select1"><?= ASSESSMENT_SECOND[4] ?>:</label>
                <?php if($gropinfo->teamleader_id1 == get_current_user_id()): ?>
    ...
    <div class="card-actionbar">
        <div class="card-actionbar-row">
            ...
            <input type="hidden" name="link" class="form-control" data-assessment value="assessment/?z=rubric_p_14">
