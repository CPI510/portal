...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'uploadAllow'   => array('image/x-ms-bmp', 'image/gif', 'image/jpeg', 'image/png', 'application/docx', 'image/x-icon', 'text/plain'), // Mimetype `image` and `text/plain` allowed to upload
		...
		array(
			...
			'uploadAllow'   => array('image/x-ms-bmp', 'image/gif', 'image/jpeg', 'application/docx', 'image/png', 'image/x-icon', 'text/plain'), // Same as above
			//'uploadAllow'   => array('image/x-ms-bmp', 'image/gif', 'image/jpeg', 'application/docx', 'image/png', 'image/x-icon', 'text/plain'), // Same as above
