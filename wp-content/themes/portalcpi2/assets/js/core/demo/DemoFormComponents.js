(function (namespace, $) {
	...
	p._initDatePicker = function () {
		...
		$('#demo-date').datepicker({autoclose: true, todayHighlight: true, format: "yyyy-mm-dd", language: 'ru'});
		$('#demo-date2').datepicker({autoclose: true, todayHighlight: true, format: "yyyy-mm-dd", language: 'ru'});
		...
		$('#demo-date-range').datepicker({todayHighlight: true, format: "yyyy-mm-dd", language: 'ru'});
